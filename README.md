...
If you want to include changes done to Switch_MAIN.txt these have to be copied into ct2hdr it in automator. Automator is installed onto your system by default.
