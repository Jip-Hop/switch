...
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 1') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 2' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 2') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 3' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 3') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 4' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 4') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 5' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 5') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 6' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 6') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 7' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 7') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 8' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 8') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 9' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 9') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
if ! [ "x$(cat "$BASE".WB | awk 'FNR == 10' | grep -v 'whitebalance')" = x ]
then
vit_01a=$(dcraw -v -c -T -A $(cat "$BASE".WB | awk 'FNR == 10') 10 10 "$O2""${BASE}"_1_"$date"_000000.dng 2>&1 | awk '/multipliers/ { print $2,$3,$4,$5; exit }')
...
#apply new AsShotNeutral tag to dng files
