...
do
ffmpeg -i "$(cat /tmp/folder_paths.txt | head -1)" -pix_fmt yuvj444p -vf scale=300:-1 -y "$(cat /tmp/folder_paths.txt | head -1 | cut -d '.' -f1)"_300px.jpg
...
while grep 'PPM\|ppm\|tiff\|tiff\|TIF\|tif\|png\|PNG\|jpg\|JPG' <<< "$(cat /tmp/folder_paths.txt)"
do
ffmpeg -i "$(cat /tmp/folder_paths.txt | head -1)" -pix_fmt yuvj444p -vf scale=500:-1 -y "$(cat /tmp/folder_paths.txt | head -1 | cut -d '.' -f1)"_500px.jpg
echo "$(tail -n +2 /tmp/folder_paths.txt)" > /tmp/folder_paths.txt
done
IFS="$OIFS"
;;
...
while grep 'PPM\|ppm\|tiff\|tiff\|TIF\|tif\|png\|PNG\|jpg\|JPG' <<< "$(cat /tmp/folder_paths.txt)"
do
ffmpeg -i "$(cat /tmp/folder_paths.txt | head -1)" -pix_fmt yuvj444p -vf scale=800:-1 -y "$(cat /tmp/folder_paths.txt | head -1 | cut -d '.' -f1)"_800px.jpg
echo "$(tail -n +2 /tmp/folder_paths.txt)" > /tmp/folder_paths.txt
done
IFS="$OIFS"
;;
...
while grep 'PPM\|ppm\|tiff\|tiff\|TIF\|tif\|png\|PNG\|jpg\|JPG' <<< "$(cat /tmp/folder_paths.txt)"
do
ffmpeg -i "$(cat /tmp/folder_paths.txt | head -1)" -pix_fmt yuvj444p -y "$(cat /tmp/folder_paths.txt | head -1 | cut -d '.' -f1)"_nocprs.jpg
echo "$(tail -n +2 /tmp/folder_paths.txt)" > /tmp/folder_paths.txt
done
IFS="$OIFS"
;;
...
while grep 'PPM\|ppm\|tiff\|tiff\|TIF\|tif\|png\|PNG\|jpg\|JPG' <<< "$(cat /tmp/folder_paths.txt)"
do
ffmpeg -i "$(cat /tmp/folder_paths.txt | head -1)" -pix_fmt yuvj444p -vf scale=$scale:-1 -y "$(cat /tmp/folder_paths.txt | head -1 | cut -d '.' -f1)"_scaled.jpg
echo "$(tail -n +2 /tmp/folder_paths.txt)" > /tmp/folder_paths.txt
done
IFS="$OIFS"
printf '\e[8;16;60t'
